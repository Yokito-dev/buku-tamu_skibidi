      ...
      <div className="bg-[#282f37]">
        ...
        <div className="absolute">
          ...
          <Image
            src={TelkomSchool}
            alt="TelkomSchool"
            style={{ marginLeft: "1060px", marginTop: "-590px", width: "18%" }}
          />
          <form onSubmit={handleSubmit}>

            <div className="ml-[1035px] mt-16">
              <input
                name="username"
                onChange={handleChenge}
                type="text"
                placeholder="Nama Pengguna :"
                className="w-[365px] px-6 py-2 border border-gray-400 rounded-full text-gray-700 bg-gray-100 focus:outline-none focus:ring-4 focus:ring-red-400 "
