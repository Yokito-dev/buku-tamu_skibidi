  ...
  return (
    <>
      <div className="bg-[#EBEAF2]">
        <div className="flex">
          <nav
            className="bg-[#BA272D] px-7 py-[364.9px]"
          ...
          <div>
            <div className="flex">
              <Link href="/dashboard">
                <p className="flex text-[25px] mt-10 ml-16 ">
                  <MdOutlineKeyboardArrowLeft />
                  <span className="text-lg mt-[-2px] font-semibold">
                    Laporan Statistik
                  </span>
                </p>
              </Link>
              <p className="text-[25px] flex mt-[35px] ml-[990px] ">
                <FaRegUserCircle />
